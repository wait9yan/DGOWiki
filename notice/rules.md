...
所以任何引起玩家矛盾、破坏游戏平衡、对服务器造成危害的行为，在原则上都不允许。<br/>
...
4. **请勿 有恶意导致服务器卡顿的行为，如：** <br/>
   滥用高频，实体方块堆叠，生物堆叠等使全服感到明显卡顿的行为。<br/>
...
5. **请勿 有严重影响服务器刷怪效率的行为，如：** <br/>
   ...
   私人养殖过多的生物，全局生物到达上限（200 只）将不会刷怪。
...
1. **请勿 恶意攻击其他玩家。** <br/>
   ...
   凶手要归还受害者失去的物品并取得原谅，以及将 **作案凶器** 送给受害者，拒绝合作直接拉黑。
...
- 没有事先协调的情况下，请在既存建筑视线范围外 _（四个区块以上）_ 再开始建造。
- 请勿建造类似「火柴盒」、无意义的「擎天柱」。 _（包括信标柱）_
- 请勿建造风格与周围建筑不符的奇葩建筑，请在各玩家聚居地范围内保持建筑风格统一。
- 请勿在各玩家聚落范围内建不符合结构学的建筑。 _（有不同要求的地区附近除外）_
