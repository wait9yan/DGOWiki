...
!(function () {
	...
	!(function (t, e) {
		...
		(window.$docsify.plugins = [].concat(function (t, f) {
			function p(t, e, a, l) {
				var o = (t || "").match(
					new RegExp(
						"".concat(
			...
			var w = (function t(e, a, l) {
				var o,
					r = 2 < arguments.length && void 0 !== l ? l : 0;
				for (o in a)
					try {
						a[o].constructor === Object && r < 1
							? (e[o] = t(e[o], a[o], r + 1))
							: (e[o] = a[o]);
					} catch (t) {
						e[o] = a[o];
			...
			t.afterEach(function (t, e) {
				e(
					t.replace(
						...
						function (t, e, a, l) {
							!w[e.toLowerCase()] &&
								w.typeMappings[e.toLowerCase()] &&
								(e = w.typeMappings[e.toLowerCase()]);
							...
							"object" === h(d) &&
								((r = Object.keys(d).filter(function (t) {
